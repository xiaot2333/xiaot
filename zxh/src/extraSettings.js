...
let setFruits = {
  ...
  startFruits: reverseLevelUp ? [10] : [0],
  randomFunction: () => {
...
let adLink = 'https://space.bilibili.com/12344466/?spm_id_from=333.999.0.0';

// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = '合成大菡宝';
